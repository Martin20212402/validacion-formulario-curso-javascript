const submitFunction = (event) => {
    ...
    //event.preventDefault()                  //evita que prevenga la actualizacion de la web
...
function validarFormulario(){
    ...
    const camposTexto = document.querySelectorAll('input[type="text"]');            //selecciona todos los input type text
    let validacionCorrecta = true;

    camposTexto.forEach(campo => {                                              //recorro los input text que tenemos 3
    ...
    //validacion los terminos y condiciones
